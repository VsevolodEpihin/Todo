...
const typeFilter = (event)=> {
  ...
  let copyTasks = [...tasks]
  console.log(parentCurrentTarget)
  if(parentCurrentTarget.name === 'check-all') renderTask(copyTasks)
  if(parentCurrentTarget.name === 'check-active') renderTaskActive(copyTasks)
  if(parentCurrentTarget.name === 'check-completed') renderTaskCompleted(copyTasks)
