...
const typeFilter = (event)=> {
  ...
  let copyTasks = [...tasks]
  if(event.target.data === 'check-all') console.log('check-all')
  if(event.target.data === 'check-active') console.log('check-active')
  if(event.target.data === 'check-completed') console.log('check-completed')
