...
let counterTasks = () => {
  tasks.forEach((task) => {
    if(task.isChecked){
      optionButtons.lastElementChild.firstElementChild.textContent +=1 
    }
    if(!task.isChecked){
      console.log(optionButtons.firstElementChild.siblingElementChild.firstElementChild)
      optionButtons.firstElementChild.siblingElementChild.firstElementChild.textContent +=1 
    }
  })
  optionButtons.firstElementChild.firstElementChild.textContent +=1
}
