...
const typeFilter = (event)=> {
  console.log(event.target)
  let copyTasks = [...tasks]
  if(event.target.name === 'check-all') console.log('check-all')
  if(event.target.name === 'check-active') console.log('check-active')
  if(event.target.name === 'check-completed') console.log('check-completed')
